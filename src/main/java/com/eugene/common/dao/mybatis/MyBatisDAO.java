package com.eugene.common.dao.mybatis;
...
public abstract class MyBatisDAO<T, K> extends SqlSessionDaoSupport implements BaseDAO<T, K> {
    ...
    private static final String SQL_ID_GET_ALL = "getAll";
    ...
    public List<T> getAll() {
        String selectStatement = this.getSqlNameSpace() + SQL_ID_GET_ALL;
    ...
    public void delete(K id) {
        // delete record by primary key, and if error happens, then throw
        // exception
